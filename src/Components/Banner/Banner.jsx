...
const Banner = () => {
    return (
        <div>
            <div className="hero lg:min-h-screen rounded-xl" style={{backgroundImage: 'url(https://i.ibb.co/HTjXf08/Rectangle-1.png)'}}>
                <div className="hero-overlay bg-opacity-60"></div>
                <div className="hero-content text-center text-white ">
                    <div className="max-w-3xl space-y-5">
                    <h1 className="text-2xl lg:text-4xl font-bold">Discover an exceptional cooking class tailored for you!</h1>
